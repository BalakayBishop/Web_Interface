<?php
    ...
    $query = $mysqli->query("SELECT * FROM flowers WHERE name = 'Iris'");
    $get_season = $mysqli->query("SELECT s.name FROM season AS s JOIN flowers AS f ON (f.season = s.id) WHERE f.name = 'Iris'");
    $get_lighting = $mysqli->query("SELECT ss.location FROM shade_sun AS ss JOIN flowers AS f ON (f.shade_sun = ss.id) WHERE f.name = 'Iris'");
    $get_placement = $mysqli->query("SELECT io.location FROM inside_outside AS io JOIN flowers AS f ON (f.inside_outside = io.id) WHERE f.name = 'Iris'");
